...
class LtiAgsScore(models.Model):
    ...
    def clean(self):
        ...
        # Note: this must be an `is not None` check, not a truthiness check, since a `scoreGiven`
        # of 0 is falsy but a legitimate value that still requires a `scoreMaximum`.
